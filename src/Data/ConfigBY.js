...
const developersFeatures = [
  {
    name: 'Кацярына',
    time: ['5г','8г'],
    tasks: ['Створана старонка з інфармацыяй пра рэжысёра','Рэалізаваная часовая шкала падзей']
  },
  {
    name: 'Уладзімір',
    time: ['5г','10г','4г'],
    tasks: ['Створаны Header, Navigation (routing), старонка са спісам рэжысёраў','Рэалізаваны пераклад сайта на тры мовы','Рэалізаваны пошук рэжысёраў']
  },
  {
    name: 'Кацярына',
    time: ['2г','7г','10г'],
    tasks: ['Створана базавая структура праекта','Рэалізаваная разметка галоўнай старонкі','Рэалізаваная карта']
  },
  {
    name: 'Антон',
    time: ['8г','2г','9г'],
    tasks: ['Створана старонка з членамі каманды','Сазданы файлы з дадзенымі','Рэалізаваны відэа блок']
  },
  {
    name: 'Кірыл',
    time: ['23г','18г'],
    tasks: ['Саздан дызайн праекта','Рэалізаваны старонкі з рабочым журналам і гідам па стылю']
  },
  {
    name: 'Раман',
    time: ['13г'],
    tasks: ['Рэалізавана фота галерэя']
  },
]
  ...
  },
  {
    ...
    photos: [
      ...
      },
      {
        ...
        text: 'Бюст Ігната Буйніцкага ў горадзе Глыбокае'
      },
    ],
  },
  {
  ...
  },
  {
    ...
    photos: [
      ...
      },
      {
        ...
        text: 'Яўген Анатолевіч Крыжаноўскі.'
      },
    ],
  },
];
