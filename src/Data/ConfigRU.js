...
const developersFeatures = [
  {
    name: 'Екатерина',
    time: ['5ч','8ч'],
    tasks: ['Создана страница с информацией о режиссёре','Реализована временная шкала событий']
  },
  {
    name: 'Владимир',
    time: ['5ч','10ч','4ч'],
    tasks: ['Созданы Header, Navigation (routing), страница со списком режиссёров','Реализован перевод сайта на три языка','Реализован поиск режиссёров']
  },
  {
    name: 'Екатерина',
    time: ['2ч','7ч','10ч'],
    tasks: ['Создана базовая структура проекта','Реализована разметка главной страницы','Реализована карта']
  },
  {
    name: 'Антон',
    time: ['8ч','2ч','9ч'],
    tasks: ['Создана страница с членами команды','Созданы файлы с данными','Реализован видео блок']
  },
  {
    name: 'Кирилл',
    time: ['23ч','18ч'],
    tasks: ['Создан дизайн проекта','Реализованы страницы с рабочим журналом и гидом по стилю']
  },
  {
    name: 'Роман',
    time: ['13ч'],
    tasks: ['Реализована фото галерея']
  },
]
